...
{
    public function __invoke(Request $request, int $record, int $attachment, AttachmentService $attachments): StreamedResponse
    {
        $actor = $request->user();
        assert($actor instanceof User);
        $file = $attachments->download($actor, $record, $attachment);
