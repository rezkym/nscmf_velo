...
use App\Http\Requests\Nscmf\Workflow\ReviewReturnRequest;
use App\Models\User;
...
{
    public function __invoke(ReviewReturnRequest $request, int $record, NscmfWorkflowService $workflow): RedirectResponse
    {
        $user = $request->user();
