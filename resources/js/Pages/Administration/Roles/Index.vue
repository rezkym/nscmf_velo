            ...
            <div class="flex items-start justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                        Roles group permissions. A user with several roles gets all of their permissions; changing a
                        role's permissions signs affected users out.
                    </p>
                </div>
                <Button v-if="can('roles.create')" data-testid="create-role-btn" @click="openNameForm(null)">
                    Create role
                </Button>
            </div>
