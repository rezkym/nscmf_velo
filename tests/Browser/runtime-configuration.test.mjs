...
test('browser runtime preserves the disposable primary defaults and isolated ports', () => {
...
test('browser runtime ignores generic development database settings', () => {
    ...
    assert.equal(runtime.environment.DB_PORT, '3306');
    assert.equal(runtime.environment.DB_DATABASE, 'nscmf_testing');
});
